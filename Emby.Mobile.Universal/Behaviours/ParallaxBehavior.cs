...
namespace Emby.Mobile.Universal.Behaviours
{
    public class ParallaxBehavior : Behavior<UIElement>
    {
        public static readonly DependencyProperty ScrollerProperty = DependencyProperty.Register(
            "Scroller", typeof(FrameworkElement), typeof(ParallaxBehavior), new PropertyMetadata(default(FrameworkElement), PropertyChanged));
        ...
        public static readonly DependencyProperty MultiplierProperty = DependencyProperty.Register(
            "Multiplier", typeof(float), typeof(ParallaxBehavior), new PropertyMetadata(0.3f, PropertyChanged));
        ...
        public static readonly DependencyProperty IsHorizontalEffectProperty = DependencyProperty.Register(
            "IsHorizontalEffect", typeof(bool), typeof(ParallaxBehavior), new PropertyMetadata(default(bool), PropertyChanged));
        ...
        {
            ((ParallaxBehavior)sender)?.SetBehavior();
        }
