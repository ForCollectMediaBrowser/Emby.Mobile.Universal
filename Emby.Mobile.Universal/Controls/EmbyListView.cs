...
{
    public class EmbyListView : ListView
    {
        ...
        public static readonly DependencyProperty IsEmptyProperty = DependencyProperty.Register(
            "IsEmpty", typeof(bool), typeof(EmbyListView), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty EmptyContentProperty = DependencyProperty.Register(
            "EmptyContent", typeof(DataTemplate), typeof(EmbyListView), new PropertyMetadata(default(DataTemplate)));
        ...
        public static readonly DependencyProperty InitialisingContentProperty = DependencyProperty.Register(
            "InitialisingContent", typeof(DataTemplate), typeof(EmbyListView), new PropertyMetadata(default(DataTemplate)));
        ...
        public static readonly DependencyProperty IsInitialisingProperty = DependencyProperty.Register(
            "IsInitialising", typeof(bool), typeof(EmbyListView), new PropertyMetadata(default(bool), StateChanged));
        ...
        public static readonly DependencyProperty EmptyContentStyleProperty = DependencyProperty.Register(
            "EmptyContentStyle", typeof(Style), typeof(EmbyListView), new PropertyMetadata(default(Style)));
        ...
        public static readonly DependencyProperty InitialisingContentStyleProperty = DependencyProperty.Register(
            "InitialisingContentStyle", typeof(Style), typeof(EmbyListView), new PropertyMetadata(default(Style)));
        ...
        public static readonly DependencyProperty LoadFailedContentProperty = DependencyProperty.Register(
            "LoadFailedContent", typeof(DataTemplate), typeof(EmbyListView), new PropertyMetadata(default(DataTemplate)));
        ...
        public static readonly DependencyProperty LoadFailedProperty = DependencyProperty.Register(
            "LoadFailed", typeof(bool), typeof(EmbyListView), new PropertyMetadata(default(bool), StateChanged));
        ...
        public static readonly DependencyProperty IsAtTopProperty = DependencyProperty.Register(
            "IsAtTop", typeof(bool), typeof(EmbyListView), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty GoToTopButtonProperty = DependencyProperty.Register(
            "GoToTopButton", typeof(object), typeof(EmbyListView), new PropertyMetadata(default(object)));
        ...
        public static readonly DependencyProperty GoToTopButtonTemplateProperty = DependencyProperty.Register(
            "GoToTopButtonTemplate", typeof(DataTemplate), typeof(EmbyListView), new PropertyMetadata(default(DataTemplate)));
        ...
        public static readonly DependencyProperty ShowGoToTopButtonProperty = DependencyProperty.Register(
            "ShowGoToTopButton", typeof(bool), typeof(EmbyListView), new PropertyMetadata(true));
        ...
        public EmbyListView()
        {
            DefaultStyleKey = typeof(EmbyListView);
        }
